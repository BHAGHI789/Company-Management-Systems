    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favicon', models.ImageField(blank=True, null=True, upload_to='companies/favicons/')),
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_records', to='application1.company', verbose_name='Company'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('is_active', models.BooleanField(default=True)),
                ('joinedDate', models.DateTimeField(auto_now_add=True, verbose_name='Joined Date')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_memberships', to='application1.company', verbose_name='Company')),
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='company_memberships', to='application1.roles', verbose_name='Role')),
